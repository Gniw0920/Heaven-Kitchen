    ...
    <div class="navbar">
        <div class="nav-content">
            ...
            <div class="nav-righty">
                <a href="../registration/login.php" class="nav-stuff button">Sign up/Log in</a>
    ...
    <div class="content">
        <div class="introduction" id="intro">
            ...
            <div class="intro-col content">
                ...
                <p class="intro-text">Founded in 2015 by JS Lam. Heaven Kitchen is a young retaurant that seek the chance to serve our customer with finest dining experience. By using the fresh, imported ingredients, we will guarantee your every food we serve will take your to voyage in the ocean of food. Yet, our 5star rated reataurant is worth you to spend a peaceful,comfort dining moment with your 
        ...
        <div class="reservation" id="reservation">
            ...
            <form action="reservation.php" method="post">
                ...
                <p><input class="details" type="datetime-local" placeholder="Date and time" name="date" id="date" value="2022-01-01T19:00"></p>
...
<div class="footer-content">
            ...
            <div class="footer-ul-container">
                ...
                <li class="category-title">Check up others experience with us!</li>
                    <li><a href="../ratingviewer1/ratingviewer.php"" class="footer-link">Our Rating</a></li>
                </ul>
            </div>
